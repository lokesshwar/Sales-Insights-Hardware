...
---
##  Problem Statement
In this project, I analyzed sales data for AtliQ Hardware, an India-based company that supplies computer hardware and peripherals to clients like Surge Stores and Nomad Stores across the country. Headquartered in Delhi, AtliQ Hardware operates multiple regional offices throughout India.
